...
def get_graph_feature(x, k=20, idx=None, x_coord=None):
    ...
    #feature = torch.stack((feature - x, x), dim=1).permute(0,1,4,5,2,3).contiguous() ## B 2 N K C 3 --> B 2 C 3 N K
    #feature = torch.cat((feature,), dim=3).permute(0, 3, 4, 1, 2).contiguous() ## B C 3 N K
    return feature
