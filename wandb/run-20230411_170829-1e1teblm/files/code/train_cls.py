...
def main(args):
    ...
    model_name = f'{args.data_name}_{args.name}_{args.num_layers}_{args.num_heads}_{args.num_point}_{args.batch_size}_{args.num_features}_{args.hidden}'
...
if __name__ == '__main__':
    ...
    # logg to wandb
    name = f'{args.data_name}_{args.name}_{args.num_layers}_{args.num_heads}_{args.num_point}_{args.batch_size}_{args.num_features}_{args.hidden}'
